...
import type { CardGridConfig } from './cards'
...
<template>
  <main>
    <section class="h-120 flex flex-col justify-center items-center mt-36 pb-4 px-10">
      <div class="w-full flex-1 bg-contain bg-no-repeat bg-center"
        :style="{ backgroundImage: `url(${withBase('/assets/banner2.png')})` }">
      </div>
    </section>
